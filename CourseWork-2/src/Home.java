...
class Login {
    ...
    Login() {
        ...
        lneed = new JLabel("Create account here!");
        f.add(lneed);
        lneed.setBounds(230, 380, 150, 10);
        ...
        f.add(btnSignUp);
        btnSignUp.setBounds(220,400,150,40);
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int value=userLogin(user,psw);
                    ...
                    if (value==1) {
                        ...
                        JOptionPane.showMessageDialog(f, "Unmatched password ");
